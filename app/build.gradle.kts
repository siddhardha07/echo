...
android {
    ...
    defaultConfig {
        ...
        // Force Release mode build for maximum speed
        externalNativeBuild {
            cmake {
    ...
    buildTypes {
        ...
        debug {
            ...
            // Force Release native libs even in Debug APK
            externalNativeBuild {
                cmake {
                    arguments += "-DCMAKE_BUILD_TYPE=Release"
                }
    ...
    // Enable CMake for native llama.cpp compilation
    externalNativeBuild {
        cmake {
